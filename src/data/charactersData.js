export const charactersData = [
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Ahri is a versatile mage assassin who excels at controlling space and punishing mistakes. Her charm ability can turn the tide of battle, while her mobility allows for aggressive plays and safe escapes. Best suited for players who enjoy mind games and positioning.'
      },
      {
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Braum is a defensive tank who protects his team with his shield and crowd control. He excels at peeling for allies and setting up engagements. Best for players who enjoy supportive play and controlling enemy aggression.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Darius is a juggernaut who dominates close-range combat through sustained damage and executions. He becomes increasingly dangerous as fights continue. Perfect for players who enjoy aggressive, in-your-face combat.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Ekko is a time-manipulating skirmisher who excels at outplaying opponents. His ultimate provides a safety net for aggressive plays. Great for players who enjoy high-risk, high-reward gameplay and creative combos.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Illaoi is a powerful juggernaut who dominates through zone control and area denial. She thrives when multiple enemies engage her. Best for players who enjoy standing their ground and turning ganks into victories.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Jinx is a hyperactive marksman who excels at ranged combat and area control. Her excitement mechanic makes her deadly when scoring takedowns. Perfect for players who love chaotic, explosive gameplay.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Vi is an aggressive diver who excels at picking off priority targets. Her ultimate provides reliable engage. Great for players who enjoy straightforward, impactful plays and diving backlines.'
      },
      {
        title: 'Optimal Punish Starts',
  ...
  },
  {
    ...
    tabs: [
      {
        title: 'Key Moves',
        content: 'Yasuo is a high-skill skirmisher who flows through combat with dashes and windwalls. He scales incredibly well and rewards mastery. Best for players who enjoy mechanical expression and outplay potential.'
      },
      {
        title: 'Optimal Punish Starts',
